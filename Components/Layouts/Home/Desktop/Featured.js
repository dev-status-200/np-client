...
export default function App() {
    ...
    const tours = [
        ...
        { id:2, name:"Valley Of Kashmir", country:"", image:"/img/mocktour.png", city:"Kashmir", desc:"Lorem Ipsum is simply dummy text of the printing and typesetting industry, typesetting industry." },
        { id:4, name:"Valley Of Kashmir", country:"", image:"/img/mocktour.png", city:"Kashmir", desc:"Lorem Ipsum is simply dummy text of the printing and typesetting industry, typesetting industry." },
        { id:2, name:"Valley Of Kashmir", country:"", image:"/img/mocktour.png", city:"Kashmir", desc:"Lorem Ipsum is simply dummy text of the printing and typesetting industry, typesetting industry." },
        ...
        return(
            <div>                
                ...
                <div className="desc fs-12 text-start">
                    ...
                    <AiFillStar style={{color:'white', fontSize:15}} className="mx-1" />
                    <AiFillStar style={{color:'white', fontSize:15}} className="mx-1" />
                    <AiFillStar style={{color:'white', fontSize:15}} className="mx-1" />
                    <AiFillStar style={{color:'white', fontSize:15}} className="mx-1" />
                    <AiFillStar style={{color:'white', fontSize:15}} className="mx-1" />
